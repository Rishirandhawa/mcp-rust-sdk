...
docker-build: ## Build Docker image for testing
	...
	docker build -t mcp-rust-sdk .

docker-test: ## Run tests in Docker
	@echo "🐳 Running tests in Docker..."
	docker run --rm mcp-rust-sdk cargo test --all-features
